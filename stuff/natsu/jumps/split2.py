# sprite database (sdb.drshnaps.com/) is the best place to find sprite sheets
# Instructions:
#   - change fname below to the name of your file
#   - drag a rectangle around the frames you want to be in a sprite (same line only)
#   - if the sprite moves in a way you don't like move the red dot with the
#     mouse to identify a common anchor point on all of them
#   - hit any key to save, then type in the name of the move
#   - use arrow keys or mouse wheel to move window up and down
...
pic = image.load(fname).convert(32,SRCALPHA)   
...
def showMove(pics):
    ...
    while running:
        ...
        frame+=1
        draw.rect(screen,bgCol,(0,0,screen.get_width(),height*3))
